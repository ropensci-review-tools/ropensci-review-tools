...
.. toctree::
   ...
   pkgcheck/checks_to_markdown.md
   pkgcheck/get_default_branch.md
   pkgcheck/get_gh_token.md
   pkgcheck/get_latest_commit.md
   pkgcheck/logfile_names.md
   pkgcheck/pkgcheck_bg.md
   pkgcheck/pkgcheck-package.md
   pkgcheck/pkgcheck.md
   pkgcheck/pkgstats_data.md
   pkgcheck/render_markdown.md
```
